...
export const Drawer = ({ children, isOpen, toggle }: DrawerProps) => {
  return (
    ...
    //   )}>
    //   <List className="relative flex h-full w-screen max-w-xs flex-col space-y-6 overflow-y-scroll pb-10">
    //     {children}
    //   </List>
    //   <section
    ...
    <div
      ...
      <aside
        className={clsx(
          'delay-400 absolute right-0 h-full w-screen max-w-xs transform bg-[rgba(19,_20,_21,_0.6)] shadow-xl backdrop-blur-md transition-all duration-500 ease-in-out',
