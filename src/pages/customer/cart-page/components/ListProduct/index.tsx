...
export const ListProduct = (props: IItemProps) => {
  ...
  return (
    <div
      className={clsx('flex w-full gap-4 py-5 border-b', 'xl:gap-5 xl:py-6')}>
      <img
        src={data.src}
        alt="###"
      ...
      <div className="w-full">
        <h2
          className={clsx(
            ...
            'text-base font-medium not-italic',
        ...
        <div className="flex justify-between items-center">
          <h2 className="text-xl font-medium not-italic xl:text-2xl">
            ${data.price * data.amount}
          </h2>
          <div
            className={clsx(
              'flex gap-3 bg-snowFlake rounded-[62px] px-3',
              'md:py-1 md:px-4 xl:gap-3 xl:py-1 xl:px-4',
            )}>
